Component({
  ...
  methods: {
    ...
    initSelectValue() {
      ...
      if (this.data.type == 3 && this.getCharCount(fdate) === 1) {
        fdate += '/01'
      }
    ...
    setHours() {
      let hoursData = []
      if (this.data.hoursData && this.data.hoursData.length > 0) {
        hoursData = this.data.hoursData;
      } else {
        hoursData = this.generateArray(0, 23);
      }
      this.setData({
        hours: hoursData
      }, () => {
    ...
    setMinutes() {
      let minutesData=[]
      if (this.data.minutesData && this.data.minutesData.length > 0) {
        minutesData = this.data.minutesData
      } else {
        minutesData = this.generateArray(0, 59);
      }
      this.setData({
        minutes: minutesData
      }, () => {
    ...
    setSeconds() {
      let secondsData = []
      if (this.data.secondsData && this.data.secondsData.length > 0) {
        secondsData = this.data.secondsData;
      } else {
        secondsData = this.generateArray(0, 59);
      }
      this.setData({
        seconds: secondsData
      }, () => {
